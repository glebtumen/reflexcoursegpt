            ...
            custom_radio_group(
                options=[
                    (
                        "Курсовая",
                        "course",
                        "В режиме курсовая можно написать курсовую и другие работы, отправив лишь тему. Используйте настройки, чтобы получить более разнообразный текст",
                    ),
                    (
                        "Свободный режим",
                        "free",
                        "Свободный режим нужен для индивидуальный просьб (например, оформить источники). Работает, как обычный чат",
                    ),
                    (
                        "Курсовая по содержанию",
                        "course_by_content",
                        "В режиме курсовая по содержанию можно написать курсовую, а также другие работы, отправив тему работы и желаемое содержание в виде списка",
                    ),
                ]
            ),
            spacing="4",
